...
public class BrowserUtils {
	...
	// This function switches the driver fouces to the alert and gets the text from the Alert and returns as a string
	public String alertGetText() {
		alert = Driver.getDriver().switchTo().alert();
		return alert.getText();
	}

	// This function switchs the driver to the alert and accepts / confirms the Alert
